...
*/                    ShopHandler.openClothesShop((ClassicPlayer)player, clothesShopPos.id);
                ...
                if (vehicleShopPos != null && !player.IsInVehicle)
                {
                    ...
                    //Vanilla Unicorn
                    if (vehicleShopPos.id == 29 && ServerFactions.GetCharacterFactionId(charId) != 9 && !CharactersInventory.ExistCharacterItem(charId, "Fahrzeugschluessel VUC", "schluessel")) { HUDHandler.SendNotification(player, 3, 5000, $"Du hast hier keinen Zugriff drauf. [VUC]"); return; }
                    //Government
                    if (vehicleShopPos.id == 25 && ServerFactions.GetCharacterFactionId(charId) != 8 && !CharactersInventory.ExistCharacterItem(charId, "Fahrzeugschluessel 00", "schluessel")) { HUDHandler.SendNotification(player, 3, 5000, $"Du hast hier keinen Zugriff drauf. [00]"); return; }
                    if (vehicleShopPos.id == 26 && ServerFactions.GetCharacterFactionId(charId) != 8 && !CharactersInventory.ExistCharacterItem(charId, "Fahrzeugschluessel 00", "schluessel")) { HUDHandler.SendNotification(player, 3, 5000, $"Du hast hier keinen Zugriff drauf. [00]"); return; }
                    if (vehicleShopPos.id == 27 && ServerFactions.GetCharacterFactionId(charId) != 8 && !CharactersInventory.ExistCharacterItem(charId, "Fahrzeugschluessel 00", "schluessel")) { HUDHandler.SendNotification(player, 3, 5000, $"Du hast hier keinen Zugriff drauf. [00]"); return; }
                    if (vehicleShopPos.id == 28 && ServerFactions.GetCharacterFactionId(charId) != 8 && !CharactersInventory.ExistCharacterItem(charId, "Fahrzeugschluessel 00", "schluessel")) { HUDHandler.SendNotification(player, 3, 5000, $"Du hast hier keinen Zugriff drauf. [00]"); return; }
                    //FIB
                    if (vehicleShopPos.id == 30 && ServerFactions.GetCharacterFactionId(charId) != 3 && !CharactersInventory.ExistCharacterItem(charId, "Fahrzeugschluessel FIB", "schluessel")) { HUDHandler.SendNotification(player, 3, 5000, $"Du hast hier keinen Zugriff drauf. [FIB]"); return; }
                    //VUC
                ...
                if (player.Position.IsInRange(Constants.Positions.Clothes_Medic, 2.5f) && !player.IsInVehicle)
                {
                    ...
                    if (factionId == 4)
                    {
                        if (!player.HasData("HasMedicClothesOn"))
                        {
                            ...
                            {
                                //Weiblich;Female
                            player.EmitLocked("Client:SpawnArea:setCharClothes", 4, 43, 0);
                            player.EmitLocked("Client:SpawnArea:setCharClothes", 11, 258, 0);
                            player.EmitLocked("Client:SpawnArea:setCharClothes", 8, 152, 0);
                            player.EmitLocked("Client:SpawnArea:setCharClothes", 10, 65, 0);
                            player.EmitLocked("Client:SpawnArea:setCharClothes", 6, 23, 0);
                            player.EmitLocked("Client:SpawnArea:setCharClothes", 3, 102, 0);
                            player.EmitLocked("Client:SpawnArea:setCharAccessory", 2, 2, 0);
                            player.EmitLocked("Client:SpawnArea:setCharAccessory", 7, 0, 0);
                            player.EmitLocked("Client:SpawnArea:setCharClothes", 1, 0, 0);
                            player.EmitLocked("Client:SpawnArea:setCharClothes", 9, 0, 0);
